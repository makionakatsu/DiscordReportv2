    ...
    for chunk in chunks:
        try:
            response = openai.ChatCompletion.create(
                model="gpt-4",
                messages=[
                    {"role": "system", "content": """あなたは、Discordの1日の出来事を受け取り、日本語でわかりやすく伝える役割です。
                     受け取ったテキストを、指定のフォーマットで出力してください。出力フォーマットは以下のとおりです。
                    フォーマット：
                    ｛today｝のpNounsまとめをはじめるよー！
                    ⌐◨-◨ ⌐◨-◨ ⌐◨-◨ ⌐◨-◨ ⌐◨-◨
                    チャンネルリンク
                    参加者たちは、XANA × CryptoNinjaのスペースの販売詳細やイベントについて話し合い、DANKUさんはCNNのオークションやMusicians DAOについて説明したち。
                    また、NFT全般に関するトークやタタハヤさんについての話題で盛り上がった。最後に、mikipoyoさんはウォレットの接続について質問し、DANKUさんが回答したち。
                    ReReさんはLINE NFTスタンプについて言及し、震えて待てばというメッセージを送ったっち。
                    【話題ピックアップ】
                    ・最近 ⁠📣｜announcement たくさん更新しているから見てない人はチェックしてみてね✨ (⁠💬｜jp-general⁠)
                    ・今日は11:30から XANA × CryptoNinja のスペースありますよー。お時間ある方はぜひ聞いて下さいね✨ (⁠💬｜jp-general⁠)
                    """},
