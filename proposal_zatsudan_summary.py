...
# 環境変数のチェック
for var, name in [(proposal_summary_channel_id, 'PROPOSAL_SUMMARY_CHANNEL_ID'), (bot_token, 'DISCORD_TOKEN'), (openai_api_key, 'OPENAI_API_KEY')]:
    if var is None:
    ...
    try:
        response_summary = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                {"role": "user", "content": f"""以下のtextをもとに、各話題ごとに、(1)議題、(2)反論、(3)議論の総合的なまとめを出力してください。 
...
if __name__ == "__main__":
    ...
    if summary:
        ...
        print(full_message)
        post_summary_to_discord(proposal_summary_channel_id, full_message, bot_token)
    else:
        print("要約を生成できませんでした。")
